...
export default function TargetShootApp({ onBack, onReward, robuxBalance = 0 }) {
  ...
  return (
    <div className="flex h-full w-full flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] bg-gradient-to-b from-emerald-300 to-lime-200">
