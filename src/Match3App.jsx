...
export default function Match3App({ onBack, onReward, robuxBalance = 0 }) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] bg-gradient-to-b from-indigo-950 via-purple-900 to-fuchsia-950">
