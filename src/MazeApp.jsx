...
export default function MazeApp({ onBack, onReward, robuxBalance = 0 }) {
  ...
  return (
    <div className="flex h-full w-full flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900">
