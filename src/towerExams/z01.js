...
const Z01 = [
  {
    id: 1, type: 'choice', q: 'Hình trên có mấy con bướm?', img: '/tower/z01/q01.png',
  ...
  {
    id: 8, type: 'choice', q: 'Chọn đáp án đúng để so sánh hai nhóm:', img: '/tower/z01/q08.png',
    options: ['>', '=', '<', 'Không so sánh được'], answer: '=',
    explain: 'Bé đếm được bên trái 8 con, bên phải cũng 8 con. Hai bên bằng nhau nên điền dấu =.',
  },
  {
    id: 9, type: 'choice', q: 'Xe nào dài nhất?', img: '/tower/z01/q09.png',
  ...
  {
    id: 10, type: 'choice', q: 'Bàn cờ có dạng hình gì?', img: '/tower/z01/q10.png',
  ...
  {
    id: 11, type: 'fill', q: 'Số ?', img: '/tower/z01/q11.png',
    options: [], answer: '10',
    explain: 'Đếm được 7 cái chai, rồi lấy 7 cộng 3 bằng 10.',
  },
  {
    id: 12, type: 'fill', q: 'Điền số thích hợp: Hình trên có … khối hộp chữ nhật.', img: '/tower/z01/q12.png',
    options: [], answer: '3',
  ...
  {
    id: 14, type: 'choice', q: 'Số cần điền vào dấu hỏi chấm gồm:', img: '/tower/z01/q14.png',
  ...
  {
    id: 18, type: 'choice', q: 'Có bao nhiêu bạn ở bên tay phải của bạn đeo ba lô?', img: '/tower/z01/q18.png',
  ...
  {
    id: 24, type: 'choice', q: 'Hình tiếp theo điền vào ô trống là:', img: '/tower/z01/q24.png',
  ...
  {
    id: 25, type: 'fill', q: 'Số cần điền vào dấu hỏi chấm là …', img: '/tower/z01/q25.png',
    options: [], answer: '8',
  ...
  {
    id: 26, type: 'fill', q: 'Hình trên có … hình tròn.', img: '/tower/z01/q26.png',
    options: [], answer: '2',
    explain: 'Chú chim có 2 hình tròn: hình tròn vàng làm mình và hình tròn hồng làm đầu.',
  },
  {
    id: 27, type: 'choice', q: 'Khi xếp hàng, Ly đứng đầu hàng, Vũ đứng thứ hai, Hà đứng thứ ba. Nếu Nam đến đứng giữa Vũ và Hà thì Nam đứng thứ mấy?', img: '/tower/z01/q27.png',
  ...
  {
    id: 28, type: 'choice', q: 'Biết mỗi hàng, mỗi cột đều có đủ 4 quả trứng khác nhau. Hình cần điền vào ô có dấu hỏi chấm là:', img: '/tower/z01/q28.png',
    options: [
  ...
  {
    id: 30, type: 'choice', q: 'Hình tiếp theo là:', img: '/tower/z01/q30.png',
