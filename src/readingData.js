// Dữ liệu truyện Tập đọc — tách khỏi App.jsx để giảm kích thước file (dữ liệu thuần, không phụ thuộc state).
...
export const READING_SERIES_BY_READING_ID = READING_SERIES.reduce((items, series) => {
