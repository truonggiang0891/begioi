...
const PICTURES = [
  ...
  { id: 'rainbow', emoji: '🌈', name: 'Cầu vồng', bg: 'from-pink-100 to-indigo-200', img: '/puzzle/rainbow.svg' },
  { id: 'train', emoji: '🚂', name: 'Tàu hỏa', bg: 'from-emerald-100 to-teal-200', img: '/puzzle/train.svg' },
  { id: 'fish', emoji: '🐠', name: 'Cá vàng', bg: 'from-cyan-100 to-sky-200', img: '/puzzle/fish.svg' },
  { id: 'unicorn', emoji: '🦄', name: 'Kỳ lân', bg: 'from-rose-100 to-pink-200', img: '/puzzle/unicorn.svg' },
  { id: 'flower', emoji: '🌻', name: 'Hoa hướng dương', bg: 'from-yellow-100 to-amber-200', img: '/puzzle/flower.svg' },
  { id: 'strawberry', emoji: '🍓', name: 'Dâu tây', bg: 'from-red-100 to-rose-200', img: '/puzzle/strawberry.svg' },
  { id: 'turtle', emoji: '🐢', name: 'Rùa con', bg: 'from-lime-100 to-green-200', img: '/puzzle/turtle.svg' },
  { id: 'rocket', emoji: '🚀', name: 'Tên lửa', bg: 'from-indigo-100 to-violet-200', img: '/puzzle/rocket.svg' },
  { id: 'cake', emoji: '🎂', name: 'Bánh kem', bg: 'from-pink-100 to-rose-200', img: '/puzzle/cake.svg' },
];
