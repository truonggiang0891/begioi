    ...
    return (
        <div className="fixed inset-0 z-50 flex h-[100dvh] w-full items-stretch justify-center overflow-hidden bg-white md:items-center md:bg-[#333a42]">
            <div className="relative flex h-full min-h-0 w-full max-w-[460px] flex-col bg-white shadow-[0_15px_35px_rgba(0,0,0,0.5)] md:h-[92vh] md:max-h-[860px] md:max-w-[520px] md:rounded-[28px] md:border-[6px] md:border-[#1a202c]">
                <header className="shrink-0 border-b border-[#e2e8f0] bg-[#f8fafc] text-center pt-[env(safe-area-inset-top)]">
                        ...
                        {orderedItems.map(({ emoji, id }) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative flex h-12 min-w-12 shrink-0 cursor-pointer items-center justify-center rounded-full border-2 border-transparent bg-[#c5d0de] text-2xl text-gray-900 shadow-[0_2px_4px_rgba(0,0,0,0.05)] transition-all ${!isUnlocked ? 'opacity-80' : ''} ${id === currentLevel ? 'scale-110 border-[#3182ce] bg-[#ebf8ff] shadow-[0_4px_8px_rgba(49,130,206,0.2)]' : ''}`}
                                >
                ...
                <div className="relative flex min-h-0 flex-1 items-center justify-center overflow-hidden bg-[#f1f5f9] px-1 py-0.5">
                    ...
                    {!favoritesEmpty && !categoryEmpty && isCurrentUnlocked && (
                        <button
                            ...
                            className={`absolute left-3 top-0.5 z-[12] grid h-8 w-8 place-items-center rounded-full border shadow-sm backdrop-blur transition active:scale-90 ${isCurrentFavorite ? 'border-rose-200 bg-rose-50' : 'border-white/80 bg-white/90'}`}
                        >
                ...
                <div className="flex shrink-0 flex-col gap-2.5 border-t border-[#e2e8f0] bg-white px-3 pt-2.5 pb-[max(1.75rem,env(safe-area-inset-bottom))]">
                    <div className="grid grid-cols-[1fr_1fr_1fr_auto] gap-1.5">
                        {Object.keys(colorThemes).map(theme => (
                            <button
                                ...
                                className={`h-10 rounded-lg border-none px-1 text-sm font-black transition-colors ${activeTheme === theme ? 'bg-[#2d3748] text-white' : 'bg-[#c5d0de] text-[#718096]'}`}
                            >
                    ...
                    <div className="grid grid-cols-6 gap-1.5">
                        <button
                            ...
                            className="grid h-12 place-items-center rounded-full bg-[#f8c4e2] text-[#db2777] transition disabled:cursor-not-allowed disabled:opacity-40"
                        >
                            <Sparkles size={19} />
                        </button>
                        <button
                            ...
                            title="Xem 3D"
                            aria-label="Xem 3D"
                            className="grid h-12 place-items-center rounded-full bg-[#c9d4ff] text-[#4f46e5] transition disabled:cursor-not-allowed disabled:opacity-40"
                        >
                            <Cuboid size={19} />
                        </button>
                        <button
                            ...
                            title="Hoàn tác"
                            aria-label="Hoàn tác"
                            className="grid h-12 place-items-center rounded-full bg-[#c5d0de] text-[#334155] transition disabled:cursor-not-allowed disabled:opacity-40"
                        >
                            <Undo2 size={19} />
                        </button>
                        <button
                        ...
                        <button
                            ...
                            title="Cục tẩy"
                            aria-label="Cục tẩy"
                            className={`grid h-12 place-items-center rounded-full transition disabled:cursor-not-allowed disabled:opacity-40 ${isEraserActive ? 'bg-[#2d3748] text-white shadow-sm' : 'bg-[#c5d0de] text-[#334155]'}`}
                        >
                            <Eraser size={19} />
                        </button>
                        <button
                            ...
                            title="Vẽ lại"
                            aria-label="Vẽ lại"
                            className="grid h-12 place-items-center rounded-full bg-[#f9a8a8] text-[#c53030] disabled:cursor-not-allowed disabled:opacity-40"
                        >
                            <RotateCcw size={19} />
                        </button>
                    </div>
